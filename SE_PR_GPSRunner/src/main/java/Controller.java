...
public class Controller {
    ...
    private static final SimpleDateFormat displayFormat = new SimpleDateFormat("HH:mm");*/
   ...
   /* Date date = parseFormat.parse("10:30 PM");
    ...
    private static List<TrackGPS> parseTracksGPS() {
        ...
        try (DirectoryStream<Path> stream = Files.newDirectoryStream(Paths.get("C://Studium//4.Semester//PR Software//Files"))) {
            for (Path file : stream) {
                System.out.println(file.getFileName());
                document = builder.parse("C://Studium//4.Semester//PR Software//Files//" + file.getFileName());
                ...
                for (int temp = 0; temp < nTrackList.getLength(); temp++) {
                    ...
                    if (node.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        /*System.out.println(
                                (eElement.getElementsByTagName("desc").item(temp).getTextContent()));
                        Date date = displayFormat.parse("11:30 PM");
                            ...
                            if (trackSegmentNode.getNodeType() == Node.ELEMENT_NODE) {
                                ...
                                if (lElement.getElementsByTagName("ele").item(i) != null ) {
                                    if (!lElement.getElementsByTagName("ele").item(i).getTextContent().isEmpty()) {
                                        trackSegment.setElem(Double.parseDouble(lElement.getElementsByTagName("ele").item(i).getTextContent()));
                                    }
                                }
                               // System.out.println(lElement.getElementsByTagName("trkpt").item(i).getAttributes().getNamedItem("lon").getTextContent());

                                if (lElement.getElementsByTagName("trkpt").item(i).getAttributes().getNamedItem("lon") != null ) {
                                  if (!lElement.getElementsByTagName("trkpt").item(i).getAttributes().getNamedItem("lon").getTextContent().isEmpty()) {
                                        trackSegment.setTrackPointLon(Double.parseDouble(lElement.getElementsByTagName("trkpt").item(i).getAttributes().getNamedItem("lon").getTextContent()));
                                  }
                                }
                                if (lElement.getElementsByTagName("trkpt").item(i).getAttributes().getNamedItem("lat") != null ) {
                                    if (!lElement.getElementsByTagName("trkpt").item(i).getAttributes().getNamedItem("lat").getTextContent().isEmpty()) {
                                        trackSegment.setTrackPointLat(Double.parseDouble(lElement.getElementsByTagName("trkpt").item(i).getAttributes().getNamedItem("lat").getTextContent()));
                                    }
                                }
                                if (lElement.getElementsByTagName("time").item(i) != null ) {
                                    if (!lElement.getElementsByTagName("time").item(i).getTextContent().isEmpty()) {
                                        trackSegment.setTime(LocalDateTime.parse(lElement.getElementsByTagName("time").item(i).getTextContent().substring(0, 19)));;
                                    }
                                }
                            }
                    ...
                    if (node.getNodeType() == Node.ELEMENT_NODE) {
                        ...
                        for (int i = 0; i < lapList.getLength(); i++) {
                            ...
                            if (lapNode.getNodeType() == Node.ELEMENT_NODE) {
                                ...
                                if (lElement.getElementsByTagName("Lap").item(i).getAttributes().getNamedItem("StartTime") != null ) {
                                    if (!lElement.getElementsByTagName("Lap").item(i).getAttributes().getNamedItem("StartTime").getTextContent().isEmpty()) {
                                        lap.setStartTime(LocalDateTime.parse(lElement.getElementsByTagName("Lap").item(i).getAttributes().getNamedItem("StartTime").getTextContent().substring(0 ,19)));
                                    }
                                }
                                if (lElement.getElementsByTagName("MaximumSpeed").item(i) != null ) {
                                    if (!lElement.getElementsByTagName("MaximumSpeed").item(i).getTextContent().isEmpty()) {
                                ...
                                if (lElement.getElementsByTagName("TotalTimeSeconds").item(i) != null ) {
                                    if (!lElement.getElementsByTagName("TotalTimeSeconds").item(i).getTextContent().isEmpty()) {
                                ...
                                if (lElement.getElementsByTagName("DistanceMeters").item(i) != null ) {
                                    if (!lElement.getElementsByTagName("DistanceMeters").item(i).getTextContent().isEmpty()) {
                                ...
                                if (lElement.getElementsByTagName("AverageHeartRateBpm").item(i) != null ) {
                                    if (!lElement.getElementsByTagName("AverageHeartRateBpm").item(i).getTextContent().trim().isEmpty()) {
                                ...
                                if (lElement.getElementsByTagName("MaximumHeartRateBpm").item(i) != null ) {
                                    if (!lElement.getElementsByTagName("MaximumHeartRateBpm").item(i).getTextContent().trim().isEmpty()) {
                                ...
                                if (lElement.getElementsByTagName("Intensity").item(i) != null ) {
                                    if (!lElement.getElementsByTagName("Intensity").item(i).getTextContent().isEmpty()) {
                                ...
                                if (lElement.getElementsByTagName("TriggerMethod").item(i) != null ) {
                                    if (!lElement.getElementsByTagName("TriggerMethod").item(i).getTextContent().isEmpty()) {
                            ...
                            for (int j = 0; j < trackList.getLength(); j++) {
                                ...
                                if (trackNode.getNodeType() == Node.ELEMENT_NODE) {
                                    ...
                                    if (tElement.getElementsByTagName("LatitudeDegrees").item(i) != null ) {
                                        if (!tElement.getElementsByTagName("LatitudeDegrees").item(i).getTextContent().isEmpty()) {
                                    ...
                                    if (tElement.getElementsByTagName("LongitudeDegrees").item(i) != null ) {
                                        if (!tElement.getElementsByTagName("LongitudeDegrees").item(i).getTextContent().isEmpty()) {
                                    ...
                                    if (tElement.getElementsByTagName("AltitudeMeters").item(i) != null ) {
                                        if (!tElement.getElementsByTagName("AltitudeMeters").item(i).getTextContent().isEmpty()) {
                                    ...
                                    if (tElement.getElementsByTagName("DistanceMeters").item(i) != null ) {
                                        if (!tElement.getElementsByTagName("DistanceMeters").item(i).getTextContent().isEmpty()) {
                                    ...
                                    if (tElement.getElementsByTagName("HeartRateBpm").item(i) != null ) {
                                        if (!tElement.getElementsByTagName("HeartRateBpm").item(i).getTextContent().isEmpty()) {
                                    ...
                                    if (tElement.getElementsByTagName("Speed").item(i) != null ) {
                                        if (!tElement.getElementsByTagName("Speed").item(i).getTextContent().isEmpty()) {
                                    ...
                                    if (tElement.getElementsByTagName("RunCadence").item(i) != null ) {
                                        if (!tElement.getElementsByTagName("RunCadence").item(i).getTextContent().isEmpty()) {
